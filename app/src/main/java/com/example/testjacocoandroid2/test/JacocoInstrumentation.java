...
//        DEFAULT_COVERAGE_FILE_PATH = getContext().getFilesDir().getPath().toString() + "/coverage.ec";
        // /data/user/0/com.example.testjacocoandroid2/files/coverage.ec coverage.ec

        DEFAULT_COVERAGE_FILE_PATH = "/sdcard/code-coverage" + "/coverage.ec";
//        /sdcard/code-coverage

        Log.d(DEFAULT_COVERAGE_FILE_PATH, "DEFAULT_COVERAGE_FILE_PATH(" + DEFAULT_COVERAGE_FILE_PATH + ")");
